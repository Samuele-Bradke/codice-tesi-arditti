...
# NB: prima di eseguire questo script creare il database con nome (senza virgolette) "addrvalaggr", aggiungere gli indici come definito nella tesi e infine mettere i template di codice cypher da eseguire per le analisi e per le importazioni nella cartella "templates"
...
QUERY_TEMPLATE_PATH="./templates/addrvalaggr.cypher"
